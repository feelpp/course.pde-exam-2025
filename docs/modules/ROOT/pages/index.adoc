...
ifeval::["{project_name}" == "Course.pde Exam 2025"]
[.lead]
{project_name} is a GitHub repository template providing a starting point for {feelpp} projects.
endif::[]
ifeval::["{project_name}" != "Course.pde Exam 2025"]
{project_name} is a {feelpp} project. It was created using the repository template https://github.com/feelpp/course.pde-exam-2025[`feelpp/course.pde-exam-2025`].
endif::[]
